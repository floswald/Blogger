...
download.file(url="http://www.ons.gov.uk/ons/rel/lms/labour-market-statistics/june-2013/table-jobs03.xls",destfile="~/Downloads/ONS.xls")
...
download.file(url="http://www.gov.uk/government/uploads/system/uploads/attachment_data/file/229690/LiveTable212.xls",destfile="~/Downloads/ONS-houses.xls",method="wget")
...
names(mdh)[2] <- "Sector"
mdh[mdh$panel=="houses",]$value <- mdh[mdh$panel=="houses built",]$value / 1000
